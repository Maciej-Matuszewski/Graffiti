...
@interface graffitiLoginViewController ()<TTTAttributedLabelDelegate>

@end

@implementation graffitiLoginViewController
...
- (void)signinBtnAction{
    ...
    [user signUpInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        if (!error) {
            ...
            ad.window.rootViewController = [[graffitiTabBarController alloc] init];
