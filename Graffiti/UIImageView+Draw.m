...
- (UIImage*)imageByCombiningImage:(UIImage*)firstImage withImage:(UIImage*)secondImage {
    ...
    [secondImage drawInRect:CGRectMake((firstImage.size.width-secondImage.size.width)/2,(firstImage.size.height-secondImage.size.height)/2,secondImage.size.width,secondImage.size.height)];
